...
Original file is located at
    https://colab.research.google.com/drive/1wHKWxDnRKsp_UMeQl5KMTe37y-DsFMlV

<font color="#4169E1" size="7"><h1><b>🫀 Deploying Your Pneumonia Detection App!</b></h1></font>

![](https://journals.plos.org/plosone/article/figure/image?size=medium&id=10.1371/journal.pone.0256630.g014)

# Step 1. Streamlit - Deploying your model to the web
